...
<% else %>
  <link rel="shortcut icon" href="resources/themes/watea/ico/favicon.ico" />
<% end_if %>
...
<% else %>
  <link rel="apple-touch-icon" sizes="144x144" href="resources/themes/watea/ico/apple-touch-icon-144.png">
  <meta name="msapplication-TileImage" content="resources/themes/watea/ico/apple-touch-icon-144.png" />
<% end_if %>

<% if $SiteConfig.AppleTouchIcon114 %>
  <link rel="apple-touch-icon" sizes="114x114" href="$SiteConfig.AppleTouchIcon114.Link">
<% else %>
  <link rel="apple-touch-icon" sizes="114x114" href="resources/themes/watea/ico/apple-touch-icon-114.png">
<% end_if %>

<% if $SiteConfig.AppleTouchIcon72 %>
  <link rel="apple-touch-icon" sizes="72x72" href="$SiteConfig.AppleTouchIcon72.Link">
<% else %>
  <link rel="apple-touch-icon" sizes="72x72" href="resources/themes/watea/ico/apple-touch-icon-72.png">
<% end_if %>

<% if $SiteConfig.AppleTouchIcon57 %>
  <link rel="apple-touch-icon" href="$SiteConfig.AppleTouchIcon57.Link">
<% else %>
  <link rel="apple-touch-icon" href="resources/themes/watea/ico/apple-touch-icon-57.png">
<% end_if %>
